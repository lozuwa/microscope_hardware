...
public class UploadImageActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == REQUEST_IMAGE_FROM_GALLERY && null != data) {
            ...
            Bitmap myImg = null;
            try {
                myImg = MediaStore.Images.Media.getBitmap(getContentResolver(), filePath);
            } catch (IOException e) {
                Toast.makeText(UploadImageActivity.this, "Image could not be loaded", Toast.LENGTH_SHORT);
            }
